    ...
    home: {
      ...
      boardPosts: [
        ...
        },
        {
          ...
          img: "/hyrox-hero.jpg",
          eyebrow: "The Dispatch",
          title: "Calendário HYROX – Outono 2026",
        ...
        },
        {
          ...
          desc: "A primeira Abbott World Marathon Major da África entra para a série em 23 de maio de 2027. O que muda na corrida pelas seis estrelas.",
          meta: "Corridas · Junho 2026 ↗",
        },
      ],
      boardMore: "Ver todos os posts ↗",
      signupEye: "The Dispatch",
      signupLabel: "Receba o boletim semanal",
      signupNote: "Um e-mail por semana. Corridas que valem a inscrição, equipamentos que valem a pena, sem enrolação.",
      signupPlaceholder: "voce@email.com",
      signupBtn: "Quero entrar.",
      signupBtnDone: "NA LISTA.",
      signupError:
        "Algo deu errado. Escreva para hello@suorsociety.com que a gente adiciona você na mão.",
    },
    footer: {
      desc: "Cultura de corrida híbrida direto de San Diego. Corridas, equipamentos e a galera que corre e treina força no meio de tudo.",
