  ...
  en: {
    ...
    about: {
      ...
      col2: [
        ...
        "Suor Society is a hybrid culture page for people who run and lift around everything else already going on. Shoe drops, athlete spotlights, race coverage. Plus the context that’s almost always missing behind the fast times and the medals: how many years and how much of a full-time training life they really took. Your run counts the whole time you’re chasing it.",
      ],
    },
    author: {
  ...
  pt: {
    ...
    about: {
      ...
      col2: [
        ...
        "O Suor Society é uma página de cultura híbrida para quem corre e levanta peso no meio de tudo mais que já está rolando. Lançamentos de tênis, perfis de atletas, cobertura de provas. Mais o contexto que quase sempre falta por trás dos tempos rápidos e das medalhas: quantos anos e quanto de uma vida inteira dedicada ao treino aquilo realmente levou. A sua corrida vale o tempo inteiro em que você corre atrás dela.",
      ],
    },
    author: {
      metaTitle: "Thais Oney, Suor Society",
