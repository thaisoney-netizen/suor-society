...
const FAQS: { q: string; a: ReactNode; plain?: string }[] = [
  ...
  },
  {
    ...
    a: "Um dia inteiro de folga é a parte que você não pula. Um segundo dia leve ou de folga ajuda a maioria de quem tem uma rotina cheia, mas é opcional, não regra. A semana acima deixa o domingo totalmente livre e usa a sexta como esse dia flex, leve ou nada dependendo de como as pernas estão. A recuperação é quando o treino de fato gruda, então esses dias estão trabalhando de verdade.",
  },
  {
  ...
  return (
    <>
      ...
      <HowToJsonLd
        ...
        description="Um modelo de semana pra correr e fazer musculação no meio de uma rotina cheia, montado pra que os dias fortes nunca se choquem: três corridas, dois treinos de força, um dia de folga total."
        image={META.image}
        ...
        <div className="post-shell">
          <div className="post-main">
            ...
            <section className="article-hero">
              <div className="page">
                <p className="article-deck">
                  ...
                  horas. Quem tem um trabalho de tempo integral ou uma rotina cheia costuma ir bem
                  com três corridas e
            ...
            <section className="article-body">
              <div className="page">
                <p>
                  Dois esportes, um corpo, cinco ou seis dias por semana, no meio de uma vida que
            ...
            <section id="week" className="article-body">
              <div className="page">
                ...
                <p>
                  Aqui está uma semana que se sustenta pra quem treina no meio de uma rotina cheia.
                  Três corridas, dois treinos de força, montada pra que os dias fortes
                  nunca se choquem.
                </p>
